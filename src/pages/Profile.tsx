            ...
            <div className="flex-1 pb-safe-area-bottom">
                ...
                <div className="flex gap-4 border-b border-white/10 mb-6">
                    <button
                        ...
                        className={`pb-3 text-sm font-bold transition-all relative flex-1 ${activeTab === 'history' ? 'text-white' : 'text-slate-500'}`}
                    >
                    ...
                    <button
                        ...
                        className={`pb-3 text-sm font-bold transition-all relative flex-1 ${activeTab === 'settings' ? 'text-white' : 'text-slate-500'}`}
                    >
                        <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="bg-[#1A1040] border border-white/5 rounded-2xl p-4">
                            ...
                            <button className="w-full bg-[#0F0529] border border-white/10 hover:border-purple-500/50 rounded-xl p-3 text-left transition-colors flex justify-between items-center group">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 group-hover:text-purple-400 transition-colors">Atualize sua senha de acesso</p>
                                </div>
                                <Settings className="w-4 h-4 text-slate-600 group-hover:text-purple-400" />
                            </button>
                        </div>
                    </div>
                )}
