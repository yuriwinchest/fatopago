        ...
        <div className="min-h-screen bg-[#0F0529] text-white font-sans flex flex-col">
            ...
            <div className="sticky top-0 z-30 bg-[#0F0529]/90 backdrop-blur-md border-b border-white/5">
                <div className="flex items-center justify-between px-6 py-4">
                    ...
                    <h1 className="font-bold text-lg tracking-wide uppercase">Meu Perfil</h1>
                    <button onClick={handleLogout} className="p-2 -mr-2 rounded-full hover:bg-red-500/10 hover:text-red-400 transition-colors text-slate-400">
