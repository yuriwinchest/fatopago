-- Update ranking tie-breaker to favor the last user who validated (most recent wins)
-- This aligns with the new policy in the Terms and Conditions.
...
AS $$
  ...
  ORDER BY a.validations_count DESC, a.last_validation_at DESC, p.id -- DESC: Last to validate wins
