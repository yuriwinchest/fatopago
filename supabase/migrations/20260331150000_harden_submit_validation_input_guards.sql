-- Harden submit_validation input guards without changing business counters.
-- Goal: block API bypass where client sends null verdict or false verdict without justification.
...
BEGIN
  ...
  IF p_verdict = TRUE THEN
    -- Ignore evidence payload for TRUE verdict to avoid inconsistent stored data.
