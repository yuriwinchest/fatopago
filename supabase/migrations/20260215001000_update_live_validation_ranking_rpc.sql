-- Extend public RPC: live ranking for validation cycles (Landing Page).
-- Adds support for previous cycle fallback via p_cycle_offset.
-- Also constrains aggregation to the 24h window of the selected cycle.
