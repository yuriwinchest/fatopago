-- 1. Add avatar_url column to sellers table
ALTER TABLE public.sellers ADD COLUMN IF NOT EXISTS avatar_url TEXT;

-- 2. Update admin_create_seller function
DROP FUNCTION IF EXISTS public.admin_create_seller(TEXT, TEXT, TEXT, TEXT);
...
-- 3. Update admin_list_sellers function
...
-- 4. Update admin_get_seller_report function
